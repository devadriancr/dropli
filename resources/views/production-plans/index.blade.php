            ...
            <div class="card-footer bg-white d-flex justify-content-center border-0 py-3">
                <nav aria-label="Page navigation">
                    <ul class="pagination mb-0">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $productionPlans->previousPageUrl() }}" rel="prev" aria-label="Previous">
                                    &laquo;
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($productionPlans->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $productionPlans->nextPageUrl() }}" rel="next" aria-label="Next">
                                    &raquo;
                                </a>
                            </li>
                        @else
