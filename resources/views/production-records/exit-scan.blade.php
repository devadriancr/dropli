    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
        ...
        <div class="w-full max-w-4xl flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 text-center sm:text-left">Salida de Material</h1>
            </div>
                ...
                <form method="POST" action="{{ route('production-records.store-exit') }}" id="confirmForm">
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <button type="submit" id="saveBtn"
                            class="flex-1 px-6 py-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium text-lg transition-colors flex items-center justify-center">
