                            ...
                            <tr>
                                <td colspan="4" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        @if (!empty($search))
                                            <a href="{{ route('departments.index') }}" class="btn btn-sm btn-link mt-2">
                                                Limpiar búsqueda
                                            </a>
                                        @endif
                                    </div>
            ...
            <div class="card-footer bg-white border-0 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-muted small">
                        Mostrando {{ $departments->firstItem() }} a {{ $departments->lastItem() }} de
                        {{ $departments->total() }} resultados
                    </div>
                    ...
                    @if ($departments->hasPages())
                        <nav aria-label="Page navigation">
                            <ul class="pagination mb-0">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $departments->previousPageUrl() }}" rel="prev"
                                            aria-label="Previous">
                                            &laquo;
                                        </a>
                                    </li>
                                ...
                                @if ($departments->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $departments->nextPageUrl() }}" rel="next"
                                            aria-label="Next">
                                            &raquo;
                                        </a>
                                    </li>
