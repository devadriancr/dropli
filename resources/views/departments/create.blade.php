            ...
            <form action="{{ route('departments.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" id="code" class="form-control border-light-subtle @error('code') is-invalid @enderror"
                               value="{{ old('code') }}" required maxlength="20" placeholder="Ej: DEPT01">
                        @error('code')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control border-light-subtle @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" required maxlength="255" placeholder="Ej: Recursos Humanos">
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" class="form-control border-light-subtle @error('description') is-invalid @enderror"
                              rows="3" maxlength="500" placeholder="Describe las funciones y responsabilidades del departamento...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
