                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="fw-bold text-secondary text-uppercase border-light-subtle">{{ __('Nombre de Cliente') }}</th>
                    ...
                    <tbody>
                        @forelse ($customers as $customer)
                            <tr class="border-light-subtle">
                                <td class="py-3 small">{{ $customer->code }}</td>
                                <td class="py-3 small">{{ $customer->name }}</td>
                                <td class="py-3 small">{{ $customer->description ?? '-' }}</td>
                                {{-- <td class="py-3">
                                    <div class="d-flex">
                                        <a href="{{ route('customers.edit', $customer) }}" class="action-btn text-primary me-3">
                                        ...
                                        <form action="{{ route('customers.destroy', $customer) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="action-btn text-danger" style="border:none;background:none;">
