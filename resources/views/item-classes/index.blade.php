...
@section('content')
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        ...
        @if ($itemClasses->hasPages() || $itemClasses->total() > 0)
                    ...
                    @if ($itemClasses->hasPages())
                        <nav aria-label="Page navigation">
                            <ul class="pagination mb-0">
                                {{-- Previous Page Link --}}
                                @if ($itemClasses->onFirstPage())
                                    <li class="page-item disabled">
                                        <span class="page-link" aria-hidden="true">&laquo;</span>
                                    </li>
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $itemClasses->previousPageUrl() }}" rel="prev"
                                            aria-label="Previous">
                                            &laquo;
                                        </a>
                                    </li>
                                ...
                                {{-- Pagination Elements --}}
                                @foreach ($itemClasses->getUrlRange(1, $itemClasses->lastPage()) as $page => $url)
                                    @if ($page == $itemClasses->currentPage())
                                ...
                                {{-- Next Page Link --}}
                                @if ($itemClasses->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $itemClasses->nextPageUrl() }}" rel="next"
                                            aria-label="Next">
                                            &raquo;
                                        </a>
                                    </li>
